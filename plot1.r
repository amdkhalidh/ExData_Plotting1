...
raw_data <- read.csv("C:/Users/khalidm/Documents/exdata-data-household_power_consumption/household_power_consumption.txt", sep=";",stringsAsFactors=FALSE) ## Reading Electric power consumption dataset
...
axis(1,at=c("0","2","4","6"),labels=c("0","2","4","6")) ## scaling x axis
